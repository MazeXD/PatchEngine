 ...
 * https://github.com/MinecraftForge/MinecraftForge/blob/master/common/net/minecraftforge/common/Property.java
 */
...
public class Property {
     ...
     * 
     * @param _default
     *            The default to provide if the current value is not a valid
     *            integer
     * @return The value
     */
    ...
    /**
     * Checks if the current value stored in this property can be converted to
     * an integer.
     * 
