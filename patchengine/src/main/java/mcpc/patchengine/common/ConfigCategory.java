 ...
 * https://github.com/MinecraftForge/MinecraftForge/blob/master/common/net/minecraftforge/common/ConfigCategory.java
 */
...
import static mcpc.patchengine.common.Configuration.*;
...
public class ConfigCategory implements Map<String, Property> {
    ...
    // Map bouncer functions for compatibility with older mods, to be removed
    // once all mods stop using it.
    @Override
    public int size() {
